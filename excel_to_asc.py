...
def format_avere_line(row_num, data_cont, importo, codice1, codice2, data_rif, codice3, codice4):
    ...
    # User requirements:
    # Field 1: Date, Field 2: C, Field 3: Importo, Field 4: "1" (6 digits), Field 5: Same date as field 1, Field 6: Cod cli, Field 7: "1" (9 digits)
    ...
    line = f"{format_date(data_cont)},C,{importo_int:>9},{1:>6},{format_date(data_cont)},{codice1_int:>5},{1:>9}"
